...
public class RegistrationDAO implements Serializable {
    ...
    public boolean UpdateAccount(String userName,String PassWord, int role,String LastName)
            throws SQLException, NamingException {
        Connection con = null;
        PreparedStatement stm = null;
        ResultSet rs = null;
        try {
            con = DBUtils.makeConnection();
            if (con != null) {
                String sql = "update Registration set LastName=?, Password=?, isAdmin=? where UserName=?;";
                stm = con.prepareStatement(sql);
