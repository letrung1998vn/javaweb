 ...
 * @author letru
 */
@WebServlet(name = "AddMoreBookServlet", urlPatterns = {"/AddMoreBookServlet"})
public class AddMoreBookServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            if(!request.getParameter("priceMin").isEmpty()||!request.getParameter("priceMax").isEmpty()){
