...
public class MobileDAO {
    ...
    public List<tbl_MoblieDTO> SearchMobileByPriceMin(float minPrice) throws SQLException {
        Connection con = null;
        PreparedStatement stm = null;
        ResultSet rs = null;
        List<tbl_MoblieDTO> mobiles = new ArrayList<>();
    ...
    public List<tbl_MoblieDTO> SearchMobileByPriceMax(float maxPrice) throws SQLException {
        Connection con = null;
        PreparedStatement stm = null;
        ResultSet rs = null;
        List<tbl_MoblieDTO> mobiles = new ArrayList<>();
    ...
    public boolean UpdateQuantity(String mobileName, int quantity)
        ...
        try {
            con = DBUtil.makeConnection();
            if (con != null) {
                String sql = "update tbl_Mobile set quantity=quantity-? "
                        + "where mobileName=?";
                stm = con.prepareStatement(sql);
