 ...
 * @author letru
 */
public class WraperFilter implements Filter {
    ...
    private void doBeforeProcessing(RequestWrapper request, ResponseWrapper response)
        ...
        if (debug) {
            log("WraperFilter:DoBeforeProcessing");
        }
    ...
    private void doAfterProcessing(RequestWrapper request, ResponseWrapper response)
            throws IOException, ServletException {
        if (debug) {
            log("WraperFilter:DoAfterProcessing");
        }
...
//        ResponseWrapper wrappedResponse = new ResponseWrapper((HttpServletResponse) response);
          ...
          ResponseWrapper wrappedResponse=new ResponseWrapper(reps);
...
//        doBeforeProcessing(wrappedRequest, wrappedResponse);
        ...
        try {
            ...
            out.println("<br>This slide is liscent by ...");
            out.close();
        } catch (Throwable t) {
...
//        doAfterProcessing(wrappedRequest, wrappedResponse);
    ...
    public void init(FilterConfig filterConfig) {
        ...
        if (filterConfig != null) {
            if (debug) {
                log("WraperFilter: Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        ...
        StringBuffer sb = new StringBuffer("WraperFilter(");
    ...
    class RequestWrapper extends HttpServletRequestWrapper {
        ...
        public void setParameter(String name, String[] values) {
            if (debug) {
                System.out.println("WraperFilter::setParameter(" + name + "=" + values + ")" + " localParams = " + localParams);
            }
        ...
        public String getParameter(String name) {
            if (debug) {
                System.out.println("WraperFilter::getParameter(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public String[] getParameterValues(String name) {
            if (debug) {
                System.out.println("WraperFilter::getParameterValues(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Enumeration getParameterNames() {
            if (debug) {
                System.out.println("WraperFilter::getParameterNames() localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Map getParameterMap() {
            if (debug) {
                System.out.println("WraperFilter::getParameterMap() localParams = " + localParams);
            }
            if (localParams == null) {
